$(".vpop").on('click', function(e) {
    ...
    else if ($(this).data('type') == 'youtube') var srchref = "https://www.youtube.com/embed/yA53yhiOe04/";
...
$("#video-popup-close ").on('click', function(e) {
    $("#video-popup-overlay2").hide();
    $("#video-popup-iframe2").attr('src', '');
});



$('.vpop ,.vpop2').click(function() {
