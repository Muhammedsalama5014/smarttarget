...
class AdminSocialmediaController extends Controller
{
    public function index(){
        $data['branding'] = SocialmediaPage::first();
    ...
    public function updatepage(Request $request){
        ...
        $service = Socialmediapage::findOrFail(1);
        // bg_image upload
        ...
        $request->session()->flash('success','SocialMedia Updated Successfully');

        return back();
    }

    public function show(){
        $data['brandings'] = Socialmedia::all();
    ...
    public function store(Request $request){
        ...
        $main_image = Storage::putFile("socialmedia",$request->file('main_image'));
        $image1 = Storage::putFile("socialmedia",$request->file('image1'));
        $image2 = Storage::putFile("socialmedia",$request->file('image2'));
        $image3 = Storage::putFile("socialmedia",$request->file('image3'));
        $image4 = Storage::putFile("socialmedia",$request->file('image4'));
        ...
        $request->session()->flash('success','Socialmedia Added Successfully');
        return back();
    }

    public function edit($id){
        $data['branding'] = Socialmedia::findOrFail($id);
    ...
    public function update(Request $request,$id){
        ...
        $branding = Socialmedia::findOrFail($id);
        // main_image upload
        ...
        if($request->hasFile('main_image')){
            ...
            $main_image = $request->file('main_image')->store('socialmedia');
        }
        ...
        if($request->hasFile('image1')){
            ...
            $image1 = $request->file('image1')->store('socialmedia');
        }
        ...
        if($request->hasFile('image2')){
            ...
            $image2 = $request->file('image2')->store('socialmedia');
        }
        ...
        if($request->hasFile('image3')){
            ...
            $image3 = $request->file('image3')->store('socialmedia');
        }
        ...
        if($request->hasFile('image4')){
            ...
            $image4 = $request->file('image4')->store('socialmedia');
        }
        $branding->update([
            'main_image'=>$main_image,
            'title'=>$request->title,
