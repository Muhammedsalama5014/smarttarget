    ...
    <div class="page-body">
            ...
            <div class="container-fluid">
                <div class="edit-profile">
                    <div class="row">
                        <div class="col-xl-12">
                            <form class="card" method="post" action="{{ url("/dashboard/blogpage/update/1") }}" enctype="multipart/form-data">
                            @csrf
                                        ...
                                        <div class="col-sm-6 col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control" type="file" name="bg_image">
                                                 <input class="form-control" type="text" name="bg_image_title" placeholder="image title" value="{{ $blog->bg_image_title }}">
                                                 <input class="form-control" type="text" name="bg_image_desc" placeholder="image descritption " value="{{ $blog->bg_image_desc }}">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="mb-3">
