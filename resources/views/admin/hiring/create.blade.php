              ...
              <div class="row">
                ...
                <div class="col-12 col-sm-6">
                  <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Jop Create</li>
                  </ol>
                </div>
              </div>
            </div>
                ...
                <div class="card">
                  <div class="card-body">
                    <form class="form theme-form projectcreate" method="post"
                                                          action="{{ url('dashboard/hirings/store') }}"
                        ...
                        <div class="col">
                          <div class="mb-3">
                            ...
                            <input class="form-control" type="file" name="img"/>
                              <input class="form-control" type="text" name="img_title" placeholder="image title" >
                            <input class="form-control" type="text" name="img_desc" placeholder="image descritption " >
                          </div>
                        </div>
                      </div>
                      <div class="row">
                        <div class="col">
                          <div class="mb-3">
                            ...
                            <input
                              class="form-control"
                              type="text"
                              placeholder="Jop Title" name="title"
                            />
                          </div>
                        </div>
                      </div>
