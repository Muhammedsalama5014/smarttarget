    ...
    <div class="page-body">
                ...
                <div class="page-title">
                    <div class="row">
                        <div class="col-12 col-sm-6">
                            <h3>Website Service Page English</h3>
                        </div>
                        <div class="col-12 col-sm-6">
                            <ol class="breadcrumb">
            ...
            <div class="container-fluid">
                <div class="edit-profile">
                    <div class="row">
                        <div class="col-xl-12">
                            <form class="card" method="post" action="{{ url("/dashboard/servicepage/update/1") }}" enctype="multipart/form-data">
                            @csrf    
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6 col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control" type="text" name="bg_image_title" placeholder="image title" value="{{ $service->bg_image_title }}">
                                                <input class="form-control" type="text" name="bg_image_desc" placeholder="image description" value="{{ $service->bg_image_desc }}">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control" type="text" name="subtitle" value="{{ $service->subtitle }}">
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="mb-3">
