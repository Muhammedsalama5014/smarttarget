...
<html lang="en">
  ...
  <body class="home">
          ...
          <ul class="menu" id="menu">
            ...
            <li class="menu-item menu-dropdown "><a class="menu-link" href="services.html" data-toggle="submenu">Services
              ...
              <ul class="submenu">
                ...
                <li class="submenu-item"> <a class="submenu-link" href="digital-marketing.blade.php">     DIGITAL MARKETING</a> </li>
    ...
    <section class="textmessage">
      <div class="container">
        <div class="textcenter mt-0 wow fadeInUp" data-wow-duration="1s">
          <div class="w-100 text-center mt-0">
            <h1 class="title">Oops!</h1>
            <p class="textlight">Lorem ipsum dolor sit amet consectetur. Nisl sit pharetra pulvinar amet elementum. Arcu eu elit tortor accumsan. Massa lacus cursus ut congue in ultrices. Justo vulputate quis quis leo tristique suspendisse lacus sit. Scelerisque molestie elementum sem id etiam placerat non viverra.</p><a class="bottom" href="index.html"><span>Back</span> </a>
          </div>
        </div>
      </div>
      <ul class="color">
