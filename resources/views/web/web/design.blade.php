            ...
            <div class="row">
                <div class="col-sm-6 item wow fadeInLeft" data-wow-duration="1s">
                    <div class="w-100">
                        ...
                        <p class="textlight"> {{$design->description}}</p>
                        <a class="bottom" data-toggle="modal" data-target=".bd-example-modal-lg"><span>Get Service</span></a>
                    </div>
                </div>
                <div class="col-sm-6 item wow fadeInRight" data-wow-duration="1s">
                    <div class="photo"><img src="{{asset("uploads/$design->bg_image")}}" alt=""></div>
                </div>
            </div>
        </div>
        <ul class="color">
