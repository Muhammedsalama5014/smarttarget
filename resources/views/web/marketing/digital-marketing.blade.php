...
<html lang="en">
  ...
  <body class="home">
    <header class="header">
      <div class="container">
        <div class="logo"><a href="index.html" title="Smart target"> <img src="images/logo.png" alt="Smart target" title="Smart target" loading="lazy"></a></div>
        ...
        <nav class="navbar" id="navbar"><span class="cancel">
          ...
          <ul class="menu" id="menu">
            ...
            <li class="menu-item menu-dropdown "><a class="menu-link" href="services.html" data-toggle="submenu">Services
              ...
              <ul class="submenu">
                <li class="submenu-item"> <a class="submenu-link" href="branding.blade.php">  BRANDING </a></li>
                <li class="submenu-item"> <a class="submenu-link" href="digital-marketing.html">     DIGITAL MARKETING</a> </li>
                <li class="submenu-item"> <a class="submenu-link" href="seo.blade.php">    SEO/CONTENT CREATION</a> </li>
                <li class="submenu-item"> <a class="submenu-link" href="border-crossings.blade.php">  SEM/GOOGLE ADS</a> </li>
                <li class="submenu-item"> <a class="submenu-link" href="social-media.blade.php">    SOCIAL MEDIA MANAGEMENT</a> </li>
                <li class="submenu-item"> <a class="submenu-link" href="marketing-strategy.blade.php">  MARKETING STRATEGY</a></li>
                <li class="submenu-item"> <a class="submenu-link" href="media-buying.blade.php">  MEDIA BUYING</a> </li>
                <li class="submenu-item"> <a class="submenu-link" href="design.blade.php">   WEBSITE DEVELOPMENT/DESIGN</a> </li>
                <li class="submenu-item"> <a class="submenu-link" href="graphic-motion.blade.php">GRAPHIC/MOTION DESIGN</a> </li>
                <li class="submenu-item"> <a class="submenu-link" href="photo-videography.blade.php">    PHOTO/VIDEOGRAPHY & V.O</a> </li>
                <li class="submenu-item"> <a class="submenu-link" href="outsourcing.blade.php">      OUTSOURCING</a>       </li>
              </ul>
            </li>
            <li class="menu-item"><a class="menu-link" href="portfolio.blade.php">Portfolio</a></li>
            <li class="menu-item"><a class="menu-link" href="blog.blade.php">Blog</a></li>
            <li class="menu-item"><a class="menu-link" href="aboutus.html">About Us</a></li>
            <li class="menu-item"><a class="menu-link" href="pricing.blade.php">Pricing</a></li>
            <li class="menu-item"><a class="menu-link" href="hiring.blade.php">Hiring</a></li>
            <li class="menu-item"><a class="menu-link" href="letstalk.blade.php">Let’s Talk</a></li>
          </ul>
        </nav>
        <div class="icon"><span class="searchicon">
            <svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M3.32241 19.3897C-1.10733 14.9599 -1.10724 7.75196 3.32241 3.32213C7.75224 -1.1077 14.9601 -1.1077 19.3898 3.32213C23.1479 7.08024 23.7171 12.6695 21.0988 17.0341C21.0988 17.0341 20.9108 17.3496 21.1648 17.6035C22.6138 19.0524 26.9613 23.4 26.9613 23.4C28.1151 24.5537 28.3897 26.1669 27.3666 27.1902L27.1904 27.3662C26.1673 28.3895 24.554 28.115 23.4003 26.9612C23.4003 26.9612 19.062 22.6228 17.6159 21.1768C17.3497 20.9107 17.0343 21.0987 17.0343 21.0987C12.6698 23.7169 7.08052 23.1478 3.32241 19.3897ZM17.2923 17.2921C20.5655 14.0189 20.5654 8.69311 17.2922 5.41992C14.019 2.14682 8.69322 2.14673 5.42011 5.41992C2.14692 8.69302 2.14692 14.0189 5.42011 17.2921C8.69331 20.5651 14.019 20.5651 17.2923 17.2921Z" fill="url(#paint0_linear_1_316)"></path>
              <path d="M16.5678 10.6819C16.7202 10.6819 16.875 10.6519 17.0243 10.5889C17.6206 10.3365 17.8996 9.64845 17.6472 9.05204C16.061 5.3034 11.7208 3.54423 7.97225 5.13049C7.37594 5.38287 7.09695 6.07092 7.34933 6.66732C7.6018 7.26373 8.28967 7.54254 8.88626 7.29025C11.4438 6.20802 14.4053 7.40832 15.4874 9.96586C15.6767 10.4132 16.1109 10.6819 16.5678 10.6819Z" fill="url(#paint1_linear_1_316)"></path>
            ...
            </svg></span><a class="bottom" href="letstalk.blade.php"><span>Get Started</span></a></div>
        ...
        <div class="row">
          <div class="col-sm-6 item wow fadeInLeft" data-wow-duration="1s">
            <div class="w-100">
              ...
              <p class="textlight"> Over the past 14 years, we have worked with over 100 brands and have earned our position through a dedication to work and a focus on meeting your business needs and achieving the highest percentage of spread and sales. <br><br>Smart Target is a comprehensive advertising agency that provides its clients with the highest level of advanced marketing services. You will not find a better partner for your business success than us.</p><span class="subtext">Lorem ipsum dolor sit amet consectetur. Consequat mi tortor bibendum nunc aliquet netus enim commodo.</span><a class="bottom" data-toggle="modal" data-target=".bd-example-modal-lg"><span>Get Service</span></a>
            </div>
          </div>
          <div class="col-sm-6 item wow fadeInRight" data-wow-duration="1s">
            <div class="photo"><img src="images/about.png" alt=""></div>
          </div>
        </div>
      </div>
      <ul class="color">
      ...
      <div class="icons">
        <div class="container">
          <nav class="social"><a class="icon-facebook" href="#" target="_blank" title="Facebook">
              ...
              </svg><span>Facebook</span></a><a class="icon-instagram" href="#" target="_blank" title="Instagram">
              ...
              </svg><span>Instagram</span></a><a class="icon-twitter" href="#" target="_blank" title="Twitter">
              <svg id="Bold" enable-background="new 0 0 24 24" height="512" viewBox="0 0 24 24" width="512" xmlns="http://www.w3.org/2000/svg">
              ...
              </svg><span>twitter</span></a><a class="icon-snapchat" href="#" target="_blank" title="snapchat">
      ...
      <div class="container">
        <div class="row">
          <div class="col-sm-4 item">
            <div class="logo"><img src="images/logofoot.png" alt="" title=""></div>
            <p class="textlight">ur focus at S./MART TARGET is to fulfill our client's needs. Our ability to meet project requirements perfectly is appreciated.</p>
          </div>
          <div class="col-sm-4 item">
            <h6 class="title">Latest Work</h6>
            <div class="row">
          ...
          <div class="col-sm-4 item">
            ...
            <div class="m-contact">
              ...
              <p>Sharq- Ahmed Al-Jaber Street Abdullah Alawadhi Tower Building No. 2 – 6th Floor</p>
            </div>
            <div class="m-contact">
            ...
            <div class="m-contact">
              ...
              </svg><a href="mailTo:hello@smarttargetkwt.com">hello@smarttargetkwt.com</a>
            </div>
          </div>
        </div>
        <div class="copyright">
          <p>All right reserved to the MART TARGET © 2023</p>
        </div>
      </div><a class="scrollToTop" href="#"> <span>TOP</span></a>
    </footer><!--End Footer-->
  </body>
</html>
