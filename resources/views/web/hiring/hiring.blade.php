...
@section('body')
    ...
    <div class="slider n-bg">
        <div class="photo"><img src="{{asset("uploads/$hiring->bg_image")}}" alt="Smart target" title="Smart target"></div>
        <div class="container">
            <div>
                <h1 class="title wow fadeInUp" data-wow-duration="1s">{{$hiring->title}}</h1>
                <p class="wow fadeInUp" data-wow-duration="3s">
                    <?php echo $hiring->description?><a class="btnbottom nav__link wow fadeInUp" href="#hiring" data-wow-duration="3s">
                        Let’s Go
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-6 item wow fadeInUp" data-wow-duration="1s">
                    <div class="inner"><a class="title" href="hiring-inner.blade.php">{{$onejob->title}}</a><span class="respons"> {{$onejob->type}}</span>
                        <ul class="list">
                            <li>{{$onejob->description}}</li>
                            <li>{{$onejob->location}}</li>

                        </ul>
                        <div class="btns"><span class="date">{{ $onejob->created_at->format('d M ,Y')}}</span><a class="btnbottom" href="{{url("/hiring/request/$onejob->id")}}">
                                Read Full
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 11 14">
                                    <path d="M1.5 2.66987L9 7L1.5 11.3301L1.5 2.66987Z" stroke-width="2"></path>
                                </svg></a></div>
            ...
            {{$alljobs->links("web.paginator.pagination")}}
        </div>
    </section>
@endsection
