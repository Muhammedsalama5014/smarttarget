...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('web/css/default-theme.css') }}" />
    <link rel="stylesheet" href="{{ asset('web/css/animate.css') }}" />
    <link href="{{ asset('web/css/magnific-popup.min.css') }}" rel="stylesheet" />
        ...
        <nav class="navbar" id="navbar">
          ...
          <ul class="menu" id="menu">
            ...
            <li class="menu-item menu-dropdown">
              <a class="menu-link" href="{{url("/services")}}" data-toggle="submenu"
                >Services
                <svg
                  width="12"
                  height="12"
              ...
              <ul class="submenu">
                @foreach($services as $service)
                  <li class="submenu-item">
                    <a class="submenu-link" href="{{ url("/service/$service->id") }}"> {{ $service->title }} </a>
                  </li>
                @endforeach
              </ul>
            </li>
            <li class="menu-item">
              <a class="menu-link" href="{{url("/portfolio")}}">Portfolio</a>
            </li>
            <li class="menu-item">
              <a class="menu-link" href="{{url("/blog")}}">Blog</a>
            </li>
            <li class="menu-item">
              <a class="menu-link" href="{{url("/aboutus")}}">About Us</a>
            </li>
            <li class="menu-item">
              <a class="menu-link" href="{{url("/pricing")}}">Pricing</a>
            </li>
            <li class="menu-item">
              <a class="menu-link" href="{{url("/hiring")}}">Hiring</a>
            </li>
            <li class="menu-item">
              <a class="menu-link" href="{{url("/letstalk")}}">Let’s Talk</a>
            </li>
          </ul>
        </nav>
        <div class="icon">
          ...
          ><a class="bottom" href="letstalk.blade.php"><span>Get Started</span></a>
        </div>
          ...
          <nav class="social">
            ...
            ><a class="icon-twitter" href="{{ $setting->twitter }}" target="_blank" title="Twitter">
              ...
              >
                ...
                ></path></svg
              ><span>twitter</span></a
            ><a class="icon-snapchat" href="{{ $setting->snapchat }}" target="_blank" title="snapchat">
              <svg
                version="1.1"
                id="Layer_1"
                xmlns="http://www.w3.org/2000/svg"
            ...
            ><a class="icon-behance" href="{{ $setting->behance }}" target="_blank" title="Behance">
      ...
      <div class="container">
        <div class="row">
          <div class="col-sm-4 item">
            <div class="logo">
              <img src="{{ asset("web/images/logofoot.png") }}" alt="" title="" />
            </div>
            <p class="textlight">
